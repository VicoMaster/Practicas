...
cssMinify += ".simSelect-icon-close{cursor:pointer;right:1.2em}.simSelect-icon-close svg{color:var(--background-hover-option);transition:.1s ease-in-out}.simSelect-options{border-radius:.3em;border:1px solid var(--color-border-input);max-height:30em;min-height:min-content;overflow:hidden;overflow-y:scroll;padding:.5em;position:absolute;width:100%;z-index:9999}.simSelect-filter-header{height:2em;left:0;position:sticky;top:0;width:100%;margin-bottom:1.2em}.simSelect-filter{border-radius:.3em;border:1px solid var(--color-border-input);box-shadow:0 -10px 0 0 var(--background-color-white);font-size:1.5em;height:2em;padding:0 .5em 0 2em;width:100%}.simSelect-option-container{height:100%;width:100%}.noData,.simSelect__option{font-size:1.5em;height:1.8em;line-height:2em;padding-left:.5em}.simSelect__option{cursor:pointer}@media (hover:hover){.simSelect-icon-close:hover svg{color:red;transform:rotateZ(25deg)}.simSelect__option:hover{background-color:var(--background-hover-option);color:var(--color-text-light)}}.simSelect-hidden{opacity:0;visibility:hidden;display:none}.border-focus{border:1px solid var(--background-hover-option)}.noSelect{-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}";
